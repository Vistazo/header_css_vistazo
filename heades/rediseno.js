function updateProgressBar() {
  const e =
    ...
    100;
  document.querySelector(".progress-bardesk").style.width = e + "%";
}
...
function loadExternalScripts() {
  ...
  (t.src = "https://tpc.googlesyndication.com/sodar/sodar2.js"),
...
function toggleMenu() {
  const e = document.querySelector(".menu_burguer_bm");
  e.style.display =
    "none" === e.style.display || "" === e.style.display ? "block" : "none";
}
function toggleSearch() {
  const e = document.querySelector(".basic_search_bm");
  e.style.display =
    "none" === e.style.display || "" === e.style.display ? "block" : "none";
}
function toggleMenuMovil() {
  const e = document.querySelector(".menu_movil");
  e.style.display =
    "none" === e.style.display || "" === e.style.display ? "block" : "none";
}
function CanalWhatsapp() {
  try {
    ...
    if (e) {
      let t =
        '<img src="https://codigomarret.online/upload/img/whatsapp_37229.ico" alt="whatsapp-icon" loading="lazy" style="width: 20px; height: 20px; margin-right: 5px;">[¡Estamos en WhatsApp! 📲 <b  class="b_azul" style="color: #4097ee;" >Empieza a seguirnos ahora</b>🚀]';
      e.innerHTML = t;
      let o = document.querySelector(".b_azul");
      (o.onmouseover = () => {
...
function CanalWhatsappMovil() {
  const e = document.querySelector(".canal_whatsapp_link .canal_whatsapp");
  ...
  if (t) {
    let e =
      '<img loading="lazy" src="https://codigomarret.online/upload/img/whatsapp_37229.ico" alt="whatsapp-icon" style="width: 20px; height: 20px; margin-right: 5px;">[¡Estamos en WhatsApp! 📲 <b  class="b_azul" style="color: #4097ee;" >Empieza a seguirnos ahora</b>🚀]';
    t.innerHTML = e;
    let o = document.querySelector(".b_azul");
    (o.onmouseover = () => {
      o.style.textDecoration = "underline";
...
function cambiarImagenPautaHome() {
  var e = document.querySelector(".IMG_PAUTAS_DIGITALES .multimedia a"),
    t = document.querySelector(".IMG_PAUTAS_DIGITALES .multimedia img"),
    o = [
      {
        src: "https://codigomarret.online/upload/img/banner-mascotas-1920x200.jpg",
        href: "https://www.vistazo.com/mascotas",
      },
    ],
    n = [
      {
        src: "https://codigomarret.online/upload/img/banner-mascotas-400x100.jpg",
        href: "https://www.vistazo.com/mascotas",
      },
    ];
  let a = 0;
  ...
  function c() {
    i(o[a]), (a = (a + 1) % o.length);
  }
  function s() {
    i(n[a]), (a = (a + 1) % n.length);
  }
  e &&
    t &&
    (window.innerWidth <= 768
      ...
      ? setInterval(c, 1e4)
      : i(o[0]),
    window.innerWidth <= 768 ? s() : c());
}
function cambiarImagenPautaEstadio() {
  try {
    var e = document.querySelector(".pauta_estadio_css");
    if (e) return void (e.style.display = "none");
  } catch (e) {
    console.log(e);
  }
}
function Replica() {
  fetch("https://www.vistazo.com/rss/replicas.json")
    .then((e) => e.json())
    .then((e) => {
      const t = e.rss.channel.item[0];
      if (t) {
        const e = t.link;
        console.log("enlace json replica:", e);
        const o = document.querySelectorAll(".menu_burguer .tab-item");
        o.length >= 2 && (o[1].href = e);
      } else console.log("No se encontraron elementos en el JSON.");
    })
    .catch((e) => {
...
async function solicitarPermisoNotificaciones() {
  ...
  if ("granted" === e)
    ...
    console.warn(
      "Permiso de notificaciones denegado. Por favor, habilítalo manualmente."
    ),
    ...
    try {
      ...
      "granted" === e
        ? (console.log("Permisos otorgados por el usuario."),
          mostrarNotificacion(
            "¡Gracias!",
            "Ahora las notificaciones están habilitadas."
          ))
        : "denied" === e &&
...
function mostrarNotificacion(e, t) {
  "Notification" in window && new Notification(e, { body: t });
}
function mostrarInstruccionesPermiso() {}
async function activarNotificaciones() {
  Notification.requestPermission()
    .then((e) => {
      console.log("Estado de permisos:", e),
        "granted" === e
          ? new Notification("¡Notificaciones activadas con éxito!", {
              body: "Ahora recibirás notificaciones importantes.",
              icon: "https://codigomarret.online/upload/img/logo-vis.png",
            })
          : "denied" === e
          ? alert(
              "Parece que tienes las notificaciones desactivadas. Por favor, actívalas manualmente en la configuración del navegador."
            )
          : alert(
              "Por favor, habilita las notificaciones para recibir actualizaciones."
            );
    })
    .catch((e) => {
...
window.addEventListener("resize", cambiarImagenPautaHome),
  ...
  document.addEventListener("DOMContentLoaded", function () {
    Replica();
    var e = document.getElementById("lateral_izq");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document
      ...
      .addEventListener("mouseover", function (e) {
        if (e.target.classList && e.target.classList.length >= 2) {
          ...
          "actualidad_link" == t
            ...
            : "opinion_link" == t && LimpiaHoverMenu();
        }
      });
    document
      .querySelectorAll(".movil_nav-links li a.has-submenu")
      .forEach((e) => {
      ...
      "/" == e && cambiarImagenPautaEstadio(),
      ("/" != e && "/tes/index.html" != e) || cambiarImagenPautaHome();
  }),
  document.addEventListener("DOMContentLoaded", function () {
    const e = new IntersectionObserver(function (e, t) {
        e.forEach((e) => {
          e.isIntersecting && (videoTecarender(), t.unobserve(e.target));
        });
      }),
      t = document.querySelector(".videoteca");
    t && e.observe(t);
  }),
  document.addEventListener("DOMContentLoaded", function () {
    const e = document.querySelector(".subscribe-btn");
    (e.href = "https://suscripciones.vistazo.com/"), (e.target = "_blank");
  }),
  document.addEventListener("DOMContentLoaded", function () {
    const e = document.querySelectorAll(".teaser-related-list article a");
    e &&
  ...
  document.addEventListener("DOMContentLoaded", function () {
    let e = document.querySelector(".head_title .title.hogar a>div");
    console.log("hogarSession: ", e),
      e &&
        ((e.innerHTML = ""),
        (e.innerHTML =
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  url.some((t) => e.includes(t)) && (window.location.href = HomeHogar);
}),
  document.addEventListener("DOMContentLoaded", function () {
    const e = window.matchMedia("(max-width: 768px)").matches ? 100 : 200;
    document.querySelectorAll(".subheadline_unico").forEach(function (t) {
      const o = t.innerHTML;
      o.length > e && (t.innerHTML = o.substring(0, e) + "...");
    });
  }),
  null === document.getElementById("unico_6")
    ? console.log("El elemento con id unico_6 no existe")
    : document
        .getElementById("unico_6")
        .addEventListener("click", function (e) {
          e.preventDefault(),
            (window.location.href =
              "https://www.instagram.com/reel/DJAF19npj7b/?igsh=MTBqM2c3dHFkcmRieQ%3D%3D");
        }),
  document.addEventListener("DOMContentLoaded", function () {
    const e = document.querySelectorAll("figure.contentMedia.art-img"),
      t = document.createElement("style");
    (t.innerHTML =
      "\n    .cutline-byline {\n      position: static !important;\n      background: #323232 !important;\n      padding-top: 0.5em;\n      color: #fff !important;\n      font-size: 0.9em;\n    }\n  "),
      document.head.appendChild(t),
      e.forEach((e) => {
        const t = e.querySelector('div[frame="crop_768xfree"]'),
          o = e.querySelector(".cutline-byline");
        t && o && t.insertAdjacentElement("afterend", o);
      });
  });

  document.addEventListener("DOMContentLoaded", () => {
  const slider = document.querySelector(".slider_opinion_home .parent-nav.lst");
  const items = slider?.querySelectorAll(".lst-item") || [];
  ...
  dotsContainer.className = "vistazo-dots";
  ...
  // Insertar puntos justo después del slider
  ...
  // Pausa al pasar el mouse en escritorio
  const wrapper = document.querySelector(".slider_opinion_home");
  if (wrapper) {
