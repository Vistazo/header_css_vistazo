...
var actionsCofigCookies = {
  opciones: [{
    ...
    descripcion: 'Se refiere a la recopilaciÃ³n de informaciÃ³n del dispositivo del usuario, como su direcciÃ³n IP y configuraciÃ³n de idioma',
    accept: false, //true or false
    id: 1//ID Ãºnico
  }, {
    titulo: 'Seleccionar anuncios bÃ¡sicos',
    descripcion: 'Se refiere a la selecciÃ³n de anuncios genÃ©ricos que se basan en la temÃ¡tica del sitio web o en la ubicaciÃ³n geogrÃ¡fica del usuario.',
    accept: false,
    id: 2
  }, {
    titulo: 'Seleccionar anuncios personalizados',
    descripcion: 'Se refiere a la selecciÃ³n de anuncios que se basan en la actividad del usuario en el sitio web o en otros sitios web que ha visitado.',
    accept: false,
    id: 3
  }],
  existeItem: function () {
