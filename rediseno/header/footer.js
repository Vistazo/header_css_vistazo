/* =============================================
  ...
  const socialData = [
    {
      name: 'Facebook',
      href: 'https://facebook.com/vistazo',
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/vistazo',
      svg: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>`
    },
    {
      name: 'X / Twitter',
      href: 'https://twitter.com/vistazo',
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/vistazo',
      svg: `<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></svg>`
    },
    {
      name: 'WhatsApp',
      href: 'https://wa.me/593985860991',
      svg: `<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>`
    }
  ];
  ...
  function renderMagazine() {
    ...
    document.getElementById('edition-label').textContent = ed.badge;
    document.getElementById('mag-title').textContent     = ed.title;
    document.getElementById('mag-subtitle').textContent  = ed.subtitle;
    document.getElementById('mag-price').innerHTML =
      `Suscríbete por: <strong>${ed.priceYear}</strong> &nbsp;
       <span class="bianual">${ed.priceBianual}</span>`;

    const grid = document.getElementById('other-magazines');
    grid.innerHTML = otherMagazines.map(m =>
      `<a href="${m.href}" class="other-mag">${m.label}</a>`
    ).join('');
